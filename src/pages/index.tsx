...
export default function Home() {
  ...
  return (
    <Container>
      <Head>
        <title> Pokedex</title>
        <meta name="description" content="Know more about Pokemon!" />
        <meta property="og:image" content="/ogimage.png" />
        <meta property="og:image:secure_url" content="/ogimage.png" />
        <meta name="twitter:image" content="/ogimage.png" />
        <meta name="twitter:image:src" content="/ogimage.png" />
        <meta property="og:description" content="Know more about Pokemon!" />
      </Head>
      <Welcome data-aos="fade-up">
        Pokemon!{' '}
        <Image src="/pokeball.svg" alt="pokeball" height={50} width={50} />
      </Welcome>

      <Subtitle>Pesquise pelo nome!</Subtitle>
